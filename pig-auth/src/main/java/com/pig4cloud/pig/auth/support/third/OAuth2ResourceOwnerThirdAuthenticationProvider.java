...
public class OAuth2ResourceOwnerThirdAuthenticationProvider
	...
	private static final Logger LOGGER = LogManager.getLogger(OAuth2ResourceOwnerThirdAuthenticationProvider.class);
	...
	public void checkClient(RegisteredClient registeredClient) {
		...
		if (!registeredClient.getAuthorizationGrantTypes()
				.contains(new AuthorizationGrantType(SecurityConstants.THIRD))) {
	...
	public UsernamePasswordAuthenticationToken buildToken(Map<String, Object> reqParameters) {
		String username = (String) reqParameters.get(SecurityConstants.USERNAME);
